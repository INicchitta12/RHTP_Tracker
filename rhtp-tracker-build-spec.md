...
>
> **Rows 8 and 9 are the sharper half, because the explanation above does not reach them.** The four school-based rows were coded by activity, which is the error this section names. Rows 8 and 9 are **bare hospital names with no activity attached at all** — there was nothing to be misled by. So the rule needs its second half stated: judging the recipient is not only about refusing to read an activity, it is about **reading the recipient at all**.
>

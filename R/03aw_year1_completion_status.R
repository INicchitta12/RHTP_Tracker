...
Y1_AWARD_FILES <- c(
  ...
  AR = "ar_year1_awardees.csv",  WY = "wy_year1_awardees.csv",
...
Y1_STATUS <- tibble::tribble(
  ...
  "AR", "PARTIAL", "No", "Yes",
  "2026-09-03",
  "Two of four initiatives awarded; RISE AR and HEART closed 2026-07-24 and 2026-08-07 with no award date (session 40).",
  "data/evidence/AR/2026-09-03_ar_rhtp_home.html",

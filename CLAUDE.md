...
| **IA** | **265** | **— NO PER-RECIPIENT AMOUNT PUBLISHED on any of the 264 award actions; ONE POOL ROW at $50,000,000 (TIER 2)** | **216 award actions** | **$0 named + $50,000,000 POOLED. IOWA PRICES NOBODY. READ THE ROW COUNT** |
...
NAMED_HOSPITAL        :    939   787,490,160      19   **SC 115.8M (113 rows)** ·
                                                       ...
                                                       **DE 4 rows, $0** ·
                                                       **NC 1 row, $0**
POOL_NAMED_HOSPITALS  :      2    68,156,856       2   **IA 50.0M** — the Centers of
                                                       Excellence pool. Ten hospitals
                                                       NAMED; no per-hospital split; and
                                                       THE FIGURE IS TIER 2 (§0.2).
                                                       NE 18.2M — the Nebraska High Value
...
- **`data/reference/classification_review_queue.csv` — 27 rows (Sessions 19,
  20, 22, 23, 24, 25, 26, 27, 28, 33, 38, 40, 42, 46, 49, 50). SESSION 50
...
FIRST.** `IA_COE_POOL_IS_TIER_2` ($50,000,000) asks whether a **Tier 2** figure

...
5. **Keep working the RCJ_ONLY queue, richest first. CONNECTICUT AND NEW MEXICO
   NOW LEAD** at 7 candidates each (CT 7/6, NM 7/7), then LA 6/6, DE 5/5, AZ
   4/2, CO 4/4. **California is `INVESTIGATED_NO_LIST`** (session 34) and off
   the queue, as are Maine and Iowa (`EXTRACTED`). **CA**, TX and WI are
   `INVESTIGATED_NO_LIST`; IA, KS, MD, ME, MI, MO, NE, NH, IN, OK and NV are
   `EXTRACTED`.

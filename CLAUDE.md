...
| **IA** | **264** | **— NO PER-RECIPIENT AMOUNT PUBLISHED** | **216 award actions** | **$0 — IOWA PRICES NOBODY. READ THE ROW COUNT** |
...
| **MS** | **167** | **$104,115,146.80** (a PARTIAL YEAR — 3 of 5 programmes) | **68** | **$47,454,812** (a FLOOR — see below) |
| **SC** | **228** | **$167,299,900.69** (a PARTIAL YEAR — 4 of 5 initiatives) | **55** | **$56,587,138** (a FLOOR — see below) |
...
```
                          ROWS       DOLLARS  STATES
NAMED_HOSPITAL        :    865   706,793,190      19   **AR 92.4M (18 rows)** ·
                                                       GA 90.3M · WY 75.1M ·
                                                       AL 68.3M · AK 62.4M ·
                                                       SC 56.6M · **KS 52.2M** ·
                                                       OR 50.7M · FL 49.3M ·
...
- **`data/reference/verification_queue_2_changes.csv` — 487 rows (Session 49),
  ...
  covers.
- **`data/reference/classification_review_queue.csv` — 24 rows (Sessions 19,
  20, 22, 23, 24, 25, 26, 27, 28, 33, 38, 40, 42, 46, 49). SESSION 49 RESOLVED
  THIRTEEN OF THEM AND ADDED FOUR.**

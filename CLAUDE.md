...
`MANAGED_CARE_ORGANIZATION` | `NOT_YET_NAMED`
...
| **NC** (MIH) | **39** | **$10,000,000 (POOL level only)** | **0** | **$0 — NO PER-RECIPIENT AMOUNT. 37 county EMS agencies** |
| **NC** (ROOTS Hub Leads) | **5** | **— NO FIGURE PUBLISHED AT ALL** | **0** | **$0 — pass-through, hospitals AMONG OTHERS** |
| **AR** | **37** | **$149,177,618** (a PARTIAL YEAR — 2 of 4 initiatives) | **9** | **$21,792,688** (a FLOOR — see below) |
| **WY** | **77** | **$173,859,752** (+$30,877,990 approved NAMING NOBODY) | **31** | **$72,661,324** (a FLOOR — see below) |
...
```
                          ROWS       DOLLARS  STATES
NAMED_HOSPITAL        :    747   599,533,409      18   GA 90.3M · WY 72.7M ·
                                                       AL 66.1M · AK 62.4M ·
                                                       **SC 56.6M (55 rows)** ·
                                                       OR 50.2M · FL 49.3M ·
                                                       **MS 47.5M (68 rows)** ·
...
- **`data/reference/classification_review_queue.csv` — 15 rows (Sessions 19,
  20, 22, 23, 24, 25, 26, 27, 28, 33, 38).**

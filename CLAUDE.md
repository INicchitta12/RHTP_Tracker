...
| **AL** | 138 | $143,745,821 | **62** | **$68,323,619** (verified session 49) |
| **AK** | **244** | **$239,186,195** | **43** | **$62,396,425** (preliminary; ROLLING — see below) |
...
| **OR** | 278 | $175,312,365 | **50** | **$50,658,518** (intents to award; verified session 49) |
...
| **OK** | **69** | **$3,572,121** (+$600,000 unnamed) | **26** | **$1,314,903** (VERIFIED session 49) |
| **NV** | **156** | **$87,400,000** (POOL level only; RHIT, RHOAP, Tribal and the 14 new Flex rows carry no published total) | **42 award actions** | **$0 — NEVADA PUBLISHES NO PER-RECIPIENT AMOUNT** |
| **MI** | **145** | **$101,318,437** (a TOTAL, not a floor; +6 state agencies session 64) | **2** | **$259,121** — see below |
| **LA** | **6** | **$1,965,788** named (+$10,736,208 for 48 unnamed, in `round_amount`) | **0** | **$0 — '20 hospital-setting awards' names none of the 20** (session 64) |
...
| **IA** | **264** | **— NO PER-RECIPIENT AMOUNT PUBLISHED** (session 51 removed session 50's Tier 2 pool row) | **216 award actions** | **$0. IOWA PRICES NOBODY. READ THE ROW COUNT** |
...
| **NC** (ROOTS Hub Leads) | **5** | **— NO FIGURE PUBLISHED AT ALL** | **0** | **$0 — pass-through, hospitals AMONG OTHERS** |
| **AR** (round 1) | **37** | **$149,177,618** (THRIVE + PACT) | **18** | **$92,405,914** (VERIFIED session 49) |
| **AR** (round 2) | **43** | **$54,685,069** (RISE AR + HEART; Year 1 COMPLETE, session 69) | **12** | **$18,870,982** (3 recipients queued, `No`) |
| **WY** | **77** | **$173,859,752** (+$30,877,990 approved NAMING NOBODY) | **34** | **$75,113,626** (VERIFIED session 49) |
